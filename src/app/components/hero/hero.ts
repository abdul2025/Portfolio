...
export class Hero {
  ...
  socialLinks = [
    { icon: 'github', label: 'GitHub', href: 'https://github.com/abdul2025' },
    { icon: 'linkedin', label: 'LinkedIn', href: 'https://www.linkedin.com/in/abdulwahab-alshehri' },
    { icon: 'email', label: 'Email', href: 'mailto:abdul.2020alsh@gmail.com' },
    { icon: 'phone', label: '+966568615094', href: 'tel:+966568615094' }
  ];
